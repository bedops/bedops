...
#ifndef ROLLING_MEDIAN_VISITOR_BED_HPP
#define ROLLING_MEDIAN_VISITOR_BED_HPP
...
namespace Visitors {
  ...
  namespace BedSpecific {
    ...
    struct Median : RollingKthAverage<Process, BaseVisitor, ExceptionType> {
      ...
      // Construction
      //==============
      explicit Median(const ProcessType& pt = ProcessType(), std::size_t col = 5) :
        BaseClass(0.5, pt, col) { /* */ }
...
#endif // ROLLING_MEDIAN_VISITOR_BED_HPP
