...
#ifndef CLASS_WINDOW_AVERAGE_VISITOR_BED_H
#define CLASS_WINDOW_AVERAGE_VISITOR_BED_H
...
namespace Visitors {
  ...
  namespace BedSpecific {
    ...
    struct Average : BaseVisitor {
      ...
      explicit Average(const ProcessType& pt = ProcessType(), std::size_t col = 5)
...
#endif // CLASS_WINDOW_AVERAGE_VISITOR_BED_H
