...
sort_c_darwin_intel_i386:
	make -C ${APPDIR}/sort-bed/src -f Makefile.darwin_i386

sort_c_darwin_intel_x86_64:
	make -C ${APPDIR}/sort-bed/src -f Makefile.darwin_x86_64
...
bedops_c_darwin_intel_i386:
	make -C ${APPDIR}/bedops/src -f Makefile.darwin_i386

bedops_c_darwin_intel_x86_64:
	make -C ${APPDIR}/bedops/src -f Makefile.darwin_x86_64
...
closestfeatures_c_darwin_intel_i386:
	make -C ${APPDIR}/closestfeats/src -f Makefile.darwin_i386

closestfeatures_c_darwin_intel_x86_64:
	make -C ${APPDIR}/closestfeats/src -f Makefile.darwin_x86_64
...
bedmap_c_darwin_intel_i386:
	make -C ${APPDIR}/bedmap/src -f Makefile.darwin_i386

bedmap_c_darwin_intel_x86_64:
	make -C ${APPDIR}/bedmap/src -f Makefile.darwin_x86_64
...
bedextract_c_darwin_intel_i386:
	make -C ${APPDIR}/bedextract/src -f Makefile.darwin_i386

bedextract_c_darwin_intel_x86_64:
	make -C ${APPDIR}/bedextract/src -f Makefile.darwin_x86_64
...
wig2bed_c_darwin_intel_i386:
	make -C ${APPDIR}/conversion/src/wig2bed -f Makefile.darwin_i386

wig2bed_c_darwin_intel_x86_64:
	make -C ${APPDIR}/conversion/src/wig2bed -f Makefile.darwin_x86_64
...
starch_c_darwin_intel_i386: starchcluster
	make -C ${APPDIR}/starch/src -f Makefile.darwin_i386

starch_c_darwin_intel_x86_64: starchcluster
	make -C ${APPDIR}/starch/src -f Makefile.darwin_x86_64
