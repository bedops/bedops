...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.doctest', 'sphinx.ext.intersphinx', 'sphinx.ext.todo', 'sphinx.ext.coverage', 'sphinx.ext.pngmath', 'sphinx.ext.mathjax', 'sphinx.ext.ifconfig', 'sphinx.ext.viewcode', 'sphinx.ext.mathbase']
...
project = u'BEDOPS'
copyright = u'2014, Shane Neph, Alex Reynolds'
...
# of the sidebar.
html_logo = 'assets/logo_with_label_v2.png'
