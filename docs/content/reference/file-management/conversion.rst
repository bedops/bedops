...
Wrapper scripts around the :ref:`convert2bed <convert2bed>` utility quickly convert a variety of common genomic data types to BED with no loss of information. In using these tools, you can easily prepare data from these formats for use with core BEDOPS tools, whether VCF, GFF/GTF/GVF, BAM/SAM, RepeatMasker annotation output, etc.
