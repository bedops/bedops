...
4. Update the Github bedops/bedops master `README.md <https://github.com/bedops/bedops/blob/v2.4.37/README.md>`_ file to note the current version number, if necessary.
