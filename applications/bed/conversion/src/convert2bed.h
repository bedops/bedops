/* 
   ...
   wig2bed components, (C) 2011-2021 Scott Kuehn and Shane Neph
...
static struct option c2b_client_long_options[] = {
    ...
    { "attribute-key",                 optional_argument,   NULL,    'A' },
    ...
    { "starch-note",                   optional_argument,   NULL,    'e' },
    { "max-mem",                       optional_argument,   NULL,    'm' },
    { "sort-tmpdir",                   optional_argument,   NULL,    'r' },
    { "multisplit",                    optional_argument,   NULL,    'b' },
