...
//    typedef Visitors::BedSpecific::Extreme<ProcessScorePrecision, BaseClass, MaxOrder> Max;
...
//    typedef Visitors::BedSpecific::Extreme<ProcessScorePrecision, BaseClass, MinOrder> Min;
...
//    typedef Visitors::BedSpecific::TrimmedMean<ProcessScorePrecision, BaseClass, Ext::ArgumentError> TMean;
